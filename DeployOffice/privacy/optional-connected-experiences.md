...
Bing pune la dispoziție în Outlook pentru iOS și Android experiențele următoare:
...
Dacă administratorul v-a oferit capacitatea de a utiliza experiențe conectate opționale în aplicațiile Office incluse în Aplicațiile Microsoft 365 pentru întreprindere pe un dispozitiv Windows, accesați **Fișier** > **Cont** > **Confidențialitate cont** și selectați **Gestionare setări** pentru a gestiona setările în orice moment. Când sunt activate, veți avea opțiunea de a utiliza serviciile descrise în acest articol atunci când doriți să le utilizați. Când sunt dezactivate, acestea nu vor fi accesibile.
